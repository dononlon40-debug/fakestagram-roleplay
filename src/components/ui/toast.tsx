...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed left-1/2 top-5 z-[300] flex max-h-screen w-[calc(100%-2rem)] max-w-[360px] -translate-x-1/2 flex-col items-center p-0",
      className,
    )}
    {...props}
  />
